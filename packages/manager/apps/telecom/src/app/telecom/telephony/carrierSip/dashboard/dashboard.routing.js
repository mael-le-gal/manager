  ...
  $stateProvider.state('telecom.telephony.billingAccount.carrierSip', {
    ...
    resolve: {
      ...
      cdrsLink: /* @ngInject */ ($state, billingAccount, serviceName) =>
        $state.href('telecom.telephony.billingAccount.carrierSip.cdr', {
          billingAccount,
          serviceName,
        }),
      ...
      dashboardLink: /* @ngInject */ ($state, billingAccount, serviceName) =>
        $state.href('telecom.telephony.billingAccount.carrierSip', {
          billingAccount,
          serviceName,
        }),
      endpointsLink: /* @ngInject */ ($state, billingAccount, serviceName) =>
        $state.href('telecom.telephony.billingAccount.carrierSip.endpoints', {
          billingAccount,
          serviceName,
        }),
