export default /* @ngInject */ ($stateProvider) => {
  $stateProvider.state('pci.projects.project.training.jobs', {
    ...
    resolve: {
      ...
      job: /* @ngInject */ (PciProjectTrainingJobsService, projectId) => (jobId) =>
      ...
      submitJob: /* @ngInject */ (PciProjectTrainingJobsService, $state, projectId) => (jobSpec) => 
        PciProjectTrainingJobsService.submit(projectId, jobSpec)
          .then(({ id }) => {
