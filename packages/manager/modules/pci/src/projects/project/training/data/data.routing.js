export default /* @ngInject */ ($stateProvider) => {
  $stateProvider.state('pci.projects.project.training.data', {
    ...
    resolve: {
      ...
      attachData: /* @ngInject */ (PciProjectTrainingDataService, $state, projectId) => (dataSpec) => 
        PciProjectTrainingDataService.attach(projectId, dataSpec)
          .then(({ id }) => {
